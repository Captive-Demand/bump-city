      ...
      <div className="px-6 pt-10 pb-8 min-h-screen flex flex-col">
        ...
        <div className="flex-1">
              ...
              <RadioGroup value={role} onValueChange={(v) => setRole(v as typeof role)} className="space-y-3">
                <Label
                  ...
                  className={cn(
                    ...
                    role === "expectant-parent" ? "border-primary bg-primary/5" : "border-border"
                  )}
                >
                  <RadioGroupItem value="expectant-parent" id="expectant" />
                  <div>
                    <p className="font-semibold text-sm">I'm the expectant parent</p>
                    <p className="text-xs text-muted-foreground">Planning my own shower</p>
                  </div>
                </Label>
                <Label
                  htmlFor="planner"
                  className={cn(
                    "flex items-center gap-4 p-4 rounded-xl border-2 cursor-pointer transition-all",
                    role === "planner" ? "border-primary bg-primary/5" : "border-border"
                  )}
                >
                  <RadioGroupItem value="planner" id="planner" />
                  <div>
                    <p className="font-semibold text-sm">I'm planning for someone else</p>
                    <p className="text-xs text-muted-foreground">Hosting or co-hosting</p>
                  </div>
                </Label>
              </RadioGroup>
            </div>
          ...
          {step === 1 && (
            <div className="space-y-5">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Tell us about the shower.</p>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                {city.toLowerCase().includes("nashville") && (
                  <p className="text-xs text-primary font-medium">🎵 Nashville unlocks local vendors & events!</p>
                )}
              </div>
              <div className="space-y-1.5">
          ...
          {step === 2 && (
            <div className="space-y-5">
              <div>
                <h2 className="text-2xl font-bold">Gifting Preferences</h2>
                <p className="text-sm text-muted-foreground mt-1">Set expectations for your guests.</p>
              </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-xl border border-border">
                <div>
                  <p className="font-semibold text-sm">Clear wrapping</p>
                  <p className="text-xs text-muted-foreground">Ask guests to use clear wrapping</p>
                </div>
