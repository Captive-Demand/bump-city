...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Welcome to Bump City! Confirm your email 🎉</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Welcome to Bump City! 🎉</Heading>
        <Text style={text}>
          Hey there! Thanks for joining{' '}
          <Link href={siteUrl} style={link}>
            <strong>Bump City</strong>
          </Link>
...
const link = { color: 'hsl(0, 46%, 71%)', textDecoration: 'underline' }
const button = {
